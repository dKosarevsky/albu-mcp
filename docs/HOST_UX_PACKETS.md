...
```bash
claude mcp add-json albumentationsx '{"type":"stdio","command":"uvx","args":["--from","albumentationsx-mcp==1.15.0","albumentationsx-mcp","--allowed-root","/absolute/path/to/images","--artifact-root","/absolute/path/to/albu-artifacts"]}'
```
