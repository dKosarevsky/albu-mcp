...
```bash
claude mcp add-json albumentationsx '{"type":"stdio","command":"uvx","args":["--from","albumentationsx-mcp==1.20.0","albumentationsx-mcp","--allowed-root","/absolute/path/to/images","--artifact-root","/absolute/path/to/albu-artifacts"]}'
```
