...
As of 2026-08-01, `v1.20.0` is the current prepared release:
...
`uv run python scripts/check_release_readiness.py --tag v1.20.0` aggregates the fast release guards for the current
