...
As of 2026-08-03, `v1.21.0` is the current prepared release:
...
`uv run python scripts/check_release_readiness.py --tag v1.21.0` aggregates the fast release guards for the current
