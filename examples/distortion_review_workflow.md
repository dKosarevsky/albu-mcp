...
```text
Read albumentationsx://examples/distortion-review. Start with run_host_smoke_check for classification. Validate the
filled preview_request_template with validate_preview_request. Render a small render_preview_batch. If the user says
...
1. Read `albumentationsx://examples/distortion-review`.
