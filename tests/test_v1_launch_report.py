...
def test_v1_launch_report_tracks_manual_host_blockers() -> None:
    ...
    assert report["package_version"] == "1.21.1"
    assert report["server_version"] == "1.21.1"
...
def test_v1_launch_report_exposes_host_level_blockers() -> None:
    ...
    assert len(report["host_blockers"]) == 5
...
def test_v1_launch_report_markdown_is_reviewable() -> None:
    ...
    assert "Package version: `1.21.1`" in markdown
...
def test_committed_v1_launch_report_is_current() -> None:
    ...
    assert "As of 2026-08-13, `v1.21.1`" in readiness
