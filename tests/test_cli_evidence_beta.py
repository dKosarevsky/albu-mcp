...
def test_readme_and_usage_document_operator_cli() -> None:
    ...
    usage_expected = [
        ...
        "albu-mcp activation evidence-product-loop",
        ...
        "albu-mcp activation product-fix-validation",
        (
            "albu-mcp activation product-fix-validation --host Codex "
            "--output-dir docs/product-fix-validation --format markdown"
        ),
        "albu-mcp activation product-fix-outcome",
        (
            "albu-mcp activation product-fix-outcome --host Codex "
            "--output-dir docs/product-fix-outcome --format markdown"
        ),
        "albu-mcp activation product-fix-outcome-capture",
        (
            "albu-mcp activation product-fix-outcome-capture --host Codex "
            "--output-dir docs/product-fix-outcome-capture --format markdown"
        ),
        "albu-mcp activation product-fix-outcome-import-guard",
        (
            "albu-mcp activation product-fix-outcome-import-guard --host Codex "
        ...
        "albu-mcp activation product-fix-closure-pack",
        (
        ...
        "albu-mcp activation product-fix-closure-runbook",
        (
            "albu-mcp activation product-fix-closure-runbook --host Codex "
            "--input docs/product-fix-outcome-capture/post-fix-noisy-preview-tuning-beta-response.json "
            "--output-dir docs/product-fix-closure-runbook --format markdown"
        ),
        "albu-mcp activation product-fix-closure-pipeline",
        (
            "albu-mcp activation product-fix-closure-pipeline --host Codex "
            "--input docs/product-fix-outcome-capture/post-fix-noisy-preview-tuning-beta-response.json "
            "--output-dir docs/product-fix-closure-pipeline --format markdown"
        ),
        "albu-mcp activation product-fix-closure-import",
        (
            "albu-mcp activation product-fix-closure-import --host Codex "
            "--input docs/product-fix-outcome-capture/post-fix-noisy-preview-tuning-beta-response.json "
        ...
        (
            ...
            "--input docs/product-fix-outcome-capture/post-fix-noisy-preview-tuning-beta-response.json "
            "--output-dir docs/product-fix-closure-snapshot --format markdown"
        ),
        "albu-mcp evidence collect",
