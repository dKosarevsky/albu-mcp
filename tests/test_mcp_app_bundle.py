...
def test_inspect_wheel_accepts_one_self_contained_mcp_app(tmp_path: Path) -> None:
    wheel = tmp_path / "albumentationsx_mcp-1.21.1-py3-none-any.whl"
...
def test_inspect_sdist_requires_app_source_and_packaged_output(tmp_path: Path) -> None:
    sdist = tmp_path / "albumentationsx_mcp-1.21.1.tar.gz"
    with tarfile.open(sdist, "w:gz") as archive:
        files = {
            "albumentationsx_mcp-1.21.1/src/albumentationsx_mcp/ui/preview-review.html": _APP_HTML,
            "albumentationsx_mcp-1.21.1/mcp-app/package.json": b"{}",
            "albumentationsx_mcp-1.21.1/mcp-app/package-lock.json": b"{}",
            "albumentationsx_mcp-1.21.1/mcp-app/preview-review.html": b"<main></main>",
            "albumentationsx_mcp-1.21.1/mcp-app/src/main.ts": b"export {};",
            "albumentationsx_mcp-1.21.1/mcp-app/src/review-state.ts": b"export {};",
            "albumentationsx_mcp-1.21.1/mcp-app/src/styles.css": b":root {}",
            "albumentationsx_mcp-1.21.1/mcp-app/tsconfig.json": b"{}",
            "albumentationsx_mcp-1.21.1/mcp-app/vite.config.ts": b"export {};",
        }
...
def test_check_distributions_requires_identical_wheel_and_sdist_apps(tmp_path: Path) -> None:
    ...
    with tarfile.open(sdist, "w:gz") as archive:
        files = {
            "albumentationsx_mcp-1.21.1/src/albumentationsx_mcp/ui/preview-review.html": _APP_HTML.replace(
                b"true", b"false"
            ),
            "albumentationsx_mcp-1.21.1/mcp-app/package.json": b"{}",
            "albumentationsx_mcp-1.21.1/mcp-app/package-lock.json": b"{}",
