...
- [docs/COMMUNITY_FEEDBACK.md](docs/COMMUNITY_FEEDBACK.md), [docs/PRODUCT_DEPTH_BACKLOG.md](docs/PRODUCT_DEPTH_BACKLOG.md), [docs/PRODUCT_DEPTH_GATE.md](docs/PRODUCT_DEPTH_GATE.md), [docs/REVIEW_AGENT_V3_PLAN.md](docs/REVIEW_AGENT_V3_PLAN.md), and [docs/DATASET_QUALITY_DEPTH_PLAN.md](docs/DATASET_QUALITY_DEPTH_PLAN.md): privacy-safe intake, post-P0 product-depth candidates, product-depth gate, review-agent planning, and dataset-quality planning.
...
- [docs/RELEASE.md](docs/RELEASE.md) and [docs/DISTRIBUTION_READINESS_PACK.md](docs/DISTRIBUTION_READINESS_PACK.md): PyPI, GitHub Release, MCP Registry, and distribution readiness process.
