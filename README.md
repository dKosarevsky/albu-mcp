...
- [docs/COMMUNITY_FEEDBACK.md](docs/COMMUNITY_FEEDBACK.md), [docs/PRODUCT_DEPTH_BACKLOG.md](docs/PRODUCT_DEPTH_BACKLOG.md), and [docs/REVIEW_AGENT_V3_PLAN.md](docs/REVIEW_AGENT_V3_PLAN.md): privacy-safe intake, post-P0 product-depth candidates, and review-agent depth planning.
