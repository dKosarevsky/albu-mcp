...
- [docs/COMMUNITY_FEEDBACK.md](docs/COMMUNITY_FEEDBACK.md) and [docs/PRODUCT_DEPTH_BACKLOG.md](docs/PRODUCT_DEPTH_BACKLOG.md): privacy-safe intake and post-P0 product-depth candidates.
