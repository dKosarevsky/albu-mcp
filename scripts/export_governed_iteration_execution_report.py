...
def build_governed_iteration_execution_report() -> dict[str, Any]:
    ...
    return {
        ...
        "completed_paths": [
            ...
            (
                "Evidence-to-Product Summary path: activation evidence-product-loop combines real host, beta, "
                "and product backlog gates into one no-write friction summary."
            ),
            (
                "Evidence-to-Product Artifact path: evidence-product-loop writes real-host, beta-validation, "
